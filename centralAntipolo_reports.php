...
<html>
   ...
   <!---->
    <div class="container">
        ...
        <main>
            <h1> History of Fire Reports in Antipolo City </h1>
                ...
                <div class="widget">
                    ...
                    <div class="middle">
                        <div class="left">
                            ...
                            <form method="post" action="centralAntipolo_extract7days.php">
                ...
                <table style="background: white;">
                    ...
                    <tbody>
                        <?php foreach ($recentReports as $report) { ?>
                            <tr>
                                <form method="post" action="update_statuscentral.php">
